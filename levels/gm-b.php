            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item">
                            <a href="/levels/gm-b.php" class="nav-link active ">
                                <i class="nav-icon far fa-calendar-alt"></i>
                                <p>
                                    GM B
                                </p>
        ...
        <div style="margin-top: 57px;" class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">GM B</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="#">Home</a></li>
                                <li class="breadcrumb-item"><a> / GM B</a></li>
                            </ol>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
            ...
            <div id="result" class="container my-cont row m-0 ">
                <div id="abacus" class="row">
                    <?php
                    $sql = "SELECT * FROM gm_b WHERE `type` = 'abacus'  ORDER BY rand()";
                ...
                <div style="display:none" id="visual"  class="row">
                    <?php
                    $sql = "SELECT * FROM gm_b WHERE `type` = 'visual'  ORDER BY rand()";
                    $result = mysqli_query($conn, $sql);
                ...
                <div style="display:none" id="mul-div"  class="row">
                    <?php
                    $sql = "SELECT * FROM gm_b WHERE `type` = 'mul-div'  ORDER BY rand()";
                    $result = mysqli_query($conn, $sql);
