            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item">
                            <a href="/levels/6.php" class="nav-link  active ">
                                <i class="nav-icon far fa-calendar-alt"></i>
                                <p>
                                    Level 6
                                </p>
        ...
        <div style="margin-top: 57px;" class="content-wrapper">
            ...
            <div id="result" class="container my-cont row m-0 ">
                <div id="abacus" class="row">
                    <?php
                    $sql = "SELECT * FROM level_6 WHERE `type` = 'abacus'  ORDER BY rand()";
                ...
                <div style="display:none" id="visual"  class="row">
                    <?php
                    $sql = "SELECT * FROM level_6 WHERE `type` = 'visual'  ORDER BY rand()";
                    $result = mysqli_query($conn, $sql);
                    ...
                    if ($result) {
                        ...
                        while ($row = mysqli_fetch_assoc($result)) {
                            ...
                            if ($num == 1) {
                                echo '                                        
                                                    <input class="form-check-input rhireh-gher_ihgr_he-ihre-hfir_hifhi-visual" type="radio" name="exampleRadios" id="question-' . $i . '-a-visual">
                                                    <label class="form-check-label " for="question-' . $i . '-a-visual"> ' . $row['answer'] . '';
                            } else {
                                echo '                                        
                                                    <input class="form-check-input rh_ireh-gher-ihgr_he_ihr_ehf-ir_hifhi-visual" type="radio" name="exampleRadios" id="question-' . $i . '-a-visual">
                                                    <label class="form-check-label" for="question-' . $i . '-a-visual"> ' . (int)$row['answer'] + rand(-10, (int)$row['answer'] + 5) . '';
                            }
                            echo '
                                            </label>
                                        </div>
                            ...
                            if ($num == 2) {
                                echo '                                        
                                                <input class="form-check-input rhireh-gher_ihgr_he-ihre-hfir_hifhi-visual" type="radio" name="exampleRadios" id="question-' . $i . '-b-visual">
                                                <label class="form-check-label " for="question-' . $i . '-b-visual"> ' . $row['answer'] . '';
                            } else {
                                echo '                                        
                                                <input class="form-check-input rhir-ehgh_er-ihgr_heihr_ehf-ir_hifhi-visual" type="radio" name="exampleRadios" id="question-' . $i . '-b-visual">
                                                <label class="form-check-label" for="question-' . $i . '-b-visual"> ' . (int)$row['answer'] + rand(-10, (int)$row['answer'] + 5) . '';
                            }
                            echo '                                        </label>
                                        </div>
                                    </div>
                            ...
                            if ($num == 3) {
                                echo '                                        
                                                <input class="form-check-input rhireh-gher_ihgr_he-ihre-hfir_hifhi-visual" type="radio" name="exampleRadios" id="question-' . $i . '-c-visual">
                                                <label class="form-check-label " for="question-' . $i . '-c-visual"> ' . $row['answer'] . '';
                            } else {
                                echo '                                        
                                                <input class="form-check-input rhirehg-herihg_rhei_hr-ehfirhi_fhi-visual" type="radio" name="exampleRadios" id="question-' . $i . '-c-visual">
                                                <label class="form-check-label" for="question-' . $i . '-c-visual"> ' . (int)$row['answer'] + rand(-10, (int)$row['answer'] + 5) . '';
                            }
                            echo '                                        </label>
                                        </div>
                                    </div>
                            ...
                            if ($num == 4) {
                                echo '                                        
                                                <input class="form-check-input rhireh-gher_ihgr_he-ihre-hfir_hifhi-visual" type="radio" name="exampleRadios" id="question-' . $i . '-d-visual">
                                                <label class="form-check-label " for="question-' . $i . '-d-visual"> ' . $row['answer'] . '';
                            } else {
                                echo '                                        
                                                <input class="form-check-input rh_irehg-herih-gufu_ygr-ehfirg_ierfhi-visual" type="radio" name="exampleRadios" id="question-' . $i . '-d-visual">
                                                <label class="form-check-label" for="question-' . $i . '-d-visual"> ' . (int)$row['answer'] + rand(-10, (int)$row['answer'] + 5) . '';
                            }
                            echo '                                        </label>
                                        </div>
                                    </div>
                ...
                <div style="display:none" id="mul-div"  class="row">
                    <?php
                    $sql = "SELECT * FROM level_6 WHERE `type` = 'mul-div'  ORDER BY rand()";
                    $result = mysqli_query($conn, $sql);
                    ...
                    if ($result) {
                        ...
                        while ($row = mysqli_fetch_assoc($result)) {
                            ...
                            if ($num == 1) {
                                echo '                                        
                                                    <input class="form-check-input rhireh-gher_ihgr_he-ihre-hfir_hifhi-mul-div" type="radio" name="exampleRadios" id="question-' . $i . '-a-mul-div">
                                                    <label class="form-check-label " for="question-' . $i . '-a-mul-div"> ' . $row['answer'] . '';
                            } else {
                                echo '                                        
                                                    <input class="form-check-input rh_ireh-gher-ihgr_he_ihr_ehf-ir_hifhi-mul-div" type="radio" name="exampleRadios" id="question-' . $i . '-a-mul-divl">
                                                    <label class="form-check-label" for="question-' . $i . '-a-mul-div"> ' . (int)$row['answer'] + rand(-10, (int)$row['answer'] + 5) . '';
                            }
                            echo '
                                            </label>
                                        </div>
                            ...
                            if ($num == 2) {
                                echo '                                        
                                                <input class="form-check-input rhireh-gher_ihgr_he-ihre-hfir_hifhi-mul-div" type="radio" name="exampleRadios" id="question-' . $i . '-b-mul-div">
                                                <label class="form-check-label " for="question-' . $i . '-b-mul-div"> ' . $row['answer'] . '';
                            } else {
                                echo '                                        
                                                <input class="form-check-input rhir-ehgh_er-ihgr_heihr_ehf-ir_hifhi-visual" type="radio" name="exampleRadios" id="question-' . $i . '-b-mul-div">
                                                <label class="form-check-label" for="question-' . $i . '-b-mul-div"> ' . (int)$row['answer'] + rand(-10, (int)$row['answer'] + 5) . '';
                            }
                            echo '                                        </label>
                                        </div>
                                    </div>
                            ...
                            if ($num == 3) {
                                echo '                                        
                                                <input class="form-check-input rhireh-gher_ihgr_he-ihre-hfir_hifhi-mul-div" type="radio" name="exampleRadios" id="question-' . $i . '-c-mul-div">
                                                <label class="form-check-label " for="question-' . $i . '-c-mul-div"> ' . $row['answer'] . '';
                            } else {
                                echo '                                        
                                                <input class="form-check-input rhirehg-herihg_rhei_hr-ehfirhi_fhi-mul-div" type="radio" name="exampleRadios" id="question-' . $i . '-c-mul-div">
                                                <label class="form-check-label" for="question-' . $i . '-c-mul-div"> ' . (int)$row['answer'] + rand(-10, (int)$row['answer'] + 5) . '';
                            }
                            echo '                                        </label>
                                        </div>
                                    </div>
                            ...
                            if ($num == 4) {
                                echo '                                        
                                                <input class="form-check-input rhireh-gher_ihgr_he-ihre-hfir_hifhi-mul-div" type="radio" name="exampleRadios" id="question-' . $i . '-d-mul-div">
                                                <label class="form-check-label " for="question-' . $i . '-d-mul-div"> ' . $row['answer'] . '';
                            } else {
                                echo '                                        
                                                <input class="form-check-input rh_irehg-herih-gufu_ygr-ehfirg_ierfhi-mul-div" type="radio" name="exampleRadios" id="question-' . $i . '-d-mul-div">
                                                <label class="form-check-label" for="question-' . $i . '-d-mul-div"> ' . (int)$row['answer'] + rand(-10, (int)$row['answer'] + 5) . '';
                            }
                            echo '                                        </label>
                                        </div>
                                    </div>
